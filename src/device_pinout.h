 ...
 * @date   7-5-2022
 * @brief  File containing the pinout documentation the garden sensor
 * */
...
extern const pin_t SOIL_MOISTURE_PIN;
extern const pin_t SOIL_TEMP_PIN;
extern const pin_t SOIL_POWER_PIN;
